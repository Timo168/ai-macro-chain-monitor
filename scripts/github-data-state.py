...
INDUSTRY_FILES=['latest.json','companies.json','hardware.json','oracle.json','costs.json','sia.json','extended.json','power-load.json','projects.json','reviewed-cache.json','scheduler.json']
