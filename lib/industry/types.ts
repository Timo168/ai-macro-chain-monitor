...
export type MetricSeries = {observations:MetricObservation[]; status:'ready'|'reviewed'|'cached'|'fetch_failed'|'pending'|'authorization_required'; fetchedAt?:string; lastSuccessfulAt?:string; checkedAt?:string; error?:string; nextCheckAt?:string; note?:string};
